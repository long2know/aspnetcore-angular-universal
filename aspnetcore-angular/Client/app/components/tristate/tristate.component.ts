import { Component, Input, Output, OnInit, AfterViewInit, DoCheck, ViewChild, EventEmitter, ChangeDetectionStrategy, ChangeDetectorRef, Renderer, ElementRef, forwardRef } from '@angular/core';
...
export class Tristate implements AfterViewInit, DoCheck {
